...
public class GafferPopGraph implements org.apache.tinkerpop.gremlin.structure.Graph {
     ...
     */
    public static final String STORE_PROPERTIES = "uk.gov.gchq.gaffer.storeproperties";
     ...
     * @see Schema
     */
    public static final String SCHEMAS = "uk.gov.gchq.gaffer.schemas";

    /**
     * Configuration key for a string array of operation options.
     * Each option should in the form: key:value
     */
    public static final String OP_OPTIONS = "uk.gov.gchq.gaffer.operation.options";

    public static final String USER_ID = "uk.gov.gchq.gaffer.userId";

    public static final String DATA_AUTHS = "uk.gov.gchq.gaffer.dataAuths";
