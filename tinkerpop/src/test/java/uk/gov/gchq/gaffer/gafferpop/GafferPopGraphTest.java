...
public class GafferPopGraphTest {
    ...
    private Graph getGafferGraph() {
        return new Graph.Builder()
                .storeProperties(StreamUtil.openStream(this.getClass(), "/uk/gov/gchq/gaffer/store.properties", true))
                .addSchemas(StreamUtil.openStreams(this.getClass(), "/uk/gov/gchq/gaffer/schema", true))
                .build();
    }
