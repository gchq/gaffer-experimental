    ...
    <Grid id={"schema-builder-component"}>
      <Grid item direction="row" justify="center" alignItems="center" id={"add-schema-element-buttons"}>
        <Grid item>
          ...
          <Dialog open={state.openTypes} onClose={(e) => dispatch({ type: "handleClickCloseTypes", value: false })} id={"add-type-dialog"} aria-labelledby="add-type-dialog">
        ...
        <Grid item>
          ...
          <Dialog open={state.openEdges} onClose={(e) => dispatch({ type: "handleClickCloseEdges", value: false })} id={"add-edge-dialog"} aria-labelledby="add-edge-dialog">
        ...
        <Grid item>
          ...
          <Dialog open={state.openEntities} onClose={(e) => dispatch({ type: "handleClickCloseEntities", value: false })} id={"add-entity-dialog"} aria-labelledby="add-entity-dialog">
            <DialogTitle id="add-entity-dialog-title">{"Add Entity"}</DialogTitle>
            <DialogContent>
              <AddEntity onAddEntity={(entityObject) => {}} types={Object.keys(typesSchema)} />
            </DialogContent>
          </Dialog>
        </Grid>
      </Grid>
