                                    ...
                                    {federatedStoreIsNotSelected() && (
                                        <>
                                            ...
                                            >
                                                ...
                                                >
                                                    <SchemaBuilderDialog typesSchema={this.state.types.length === 0 ? {types:{}}: JSON.parse(this.state.types)}
                                                                         elementsSchema={this.state.elements.length === 0 ? {entities: {}, edges:{}} : JSON.parse(this.state.elements) }
