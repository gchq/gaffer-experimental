...
public class GafferHelmValuesFactoryTest {
  ...
  public void federatedStoreRequestShouldReturnFederatedRequestBody() {
    ...
    final Gaffer requestBody = GafferHelmValuesFactory.from(new GaaSCreateRequestBody("MyGraph", "Another description", "federatedStore", getSchema(), getStorePropertiesFromYAMLResources()));
  ...
  private Map<String, Object> getStorePropertiesFromYAMLResources() {
    Yaml yaml = new Yaml();
