...
public class GraphControllerTest extends AbstractTest {
    ...
    public void getGraphs_ReturnsGraphsAsList_whenSuccessful() throws Exception {
        ...
        final String expected = "{\"graphs\":[{\"graphId\":\"testgraphid\",\"description\":\"Test Graph Description\",\"url\":\"my-graph-namespace.apps.k8s.cluster\",\"status\":\"UP\",\"problems\":null,\"config\":\"mapStore\"}]}";
    ...
    public void createGraph_shouldReturn400BadRequestWhenStoreTypeIsNull() throws Exception {
        ...
        assertEquals(400, result.getResponse().getStatus());
        final String expected = "{\"title\":\"Validation failed\",\"detail\":\"\\\"configName\\\" must be defined. " +
