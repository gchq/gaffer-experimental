...
class GraphControllerTest extends AbstractTest {
        ...
        void getStoretypes_ReturnsStoretypesAsList_whenSuccessful() throws Exception {
                ...
                assertEquals("{\"storeTypes\":[{\"name\":\"accumulo\",\"parameters\":[\"schema\"]},{\"name\":\"federated\",\"parameters\":[\"proxies\"]}]}",
                                getStoretypeResponse.getResponse().getContentAsString());
        }
        ...
        void createGraph_whenSuccessful_shouldReturn201() throws Exception {
                final GaaSCreateRequestBody gaaSCreateRequestBody = new GaaSCreateRequestBody(TEST_GRAPH_ID,
                                TEST_GRAPH_DESCRIPTION, getSchema(), "accumuloStore");
        ...
        void createGraph_whenGraphIdIsNull_shouldReturn400() throws Exception {
                ...
                assertEquals("{\"title\":\"Validation failed\",\"detail\":\"Graph id should not be null\"}",
        ...
        void createGraph_whenGraphIdHasSpaces_isInvalidAndShouldReturn400() throws Exception {
                ...
                verify(createGraphService, times(0)).createGraph(any(GaaSCreateRequestBody.class));
                assertEquals("{\"title\":\"Validation failed\",\"detail\":\"Graph ID can contain only digits or lowercase letters\"}",
                                result.getResponse().getContentAsString());
                assertEquals(400, result.getResponse().getStatus());
        }
        ...
        void createGraph_whenGraphIdHasDashes_isValidAndShouldReturn201() throws Exception {
                final String graphRequest = "{\"graphId\":\"graph-with-dash\",\"description\":\""
                                + TEST_GRAPH_DESCRIPTION + "\",\"configName\":\"accumuloStore\"}";
        ...
        void createGraph_whenDescriptionIsEmptyOnly_return400() throws Exception {
                final String graphRequest = "{\"graphId\":\"" + TEST_GRAPH_ID
                                + "\",\"description\":\"\",\"configName\":\"accumuloStore\"}";
                ...
                verify(createGraphService, times(0)).createGraph(any(GaaSCreateRequestBody.class));
                assertEquals("{\"title\":\"Validation failed\",\"detail\":\"Description should not be empty\"}",
        ...
        void deleteGraph_whenGraphNDoesNotExist_return404() throws Exception {
                doThrow(new GaaSRestApiException("Graph not found", "NotFound", 404)).when(deleteGraphService)
                                .deleteGraph("nonexistentgraphfortestingpurposes");
        ...
        void createGraph_hasSameGraphIdAsExistingOne_shouldReturn409() throws Exception {
                final GaaSCreateRequestBody gaaSCreateRequestBody = new GaaSCreateRequestBody(TEST_GRAPH_ID,
                                TEST_GRAPH_DESCRIPTION, getSchema(), "accumuloStore");
                final String inputJson = mapToJson(gaaSCreateRequestBody);
                doThrow(new GaaSRestApiException("This graph", "already exists", 409)).when(createGraphService)
                                .createGraph(any(GaaSCreateRequestBody.class));
        ...
        void namespaces_shouldReturnErrorMessageWhenNamespaceServiceException() throws Exception {
                doThrow(new GaaSRestApiException("Cluster not found", "NotFound", 404)).when(getNamespacesService)
                                .getNamespaces();
                ...
                assertEquals("{\"title\":\"Cluster not found\",\"detail\":\"NotFound\"}",
                                namespacesResponse.getResponse().getContentAsString());
        }

        @Test
        void namespaces_shouldReturn200AndArrayWithNamespacesWhenNamespacesPresent() throws Exception {
                when(getNamespacesService.getNamespaces())
                                .thenReturn(Arrays.asList("dev-team-1", "dev-team-2", "test-team-5"));
                ...
                assertEquals("[\"dev-team-1\",\"dev-team-2\",\"test-team-5\"]",
                                namespacesResponse.getResponse().getContentAsString());
        }
        ...
        void createGraph_shouldReturn500BadRequestWhenStoreTypeIsInvalidType() throws Exception {
                final GaaSCreateRequestBody gaaSCreateRequestBody = new GaaSCreateRequestBody(TEST_GRAPH_ID,
                                TEST_GRAPH_DESCRIPTION, getSchema(), "invalidStore");
                final String inputJson = mapToJson(gaaSCreateRequestBody);
                doThrow(new RuntimeException(
                                "configName is Invalid must be defined Valid Store Types supported are: federatedStore, accumuloStore, proxyStore and mapStore"))
                                .when(createGraphService).createGraph(any(GaaSCreateRequestBody.class));
        ...
        void exceptionHandler_catchRuntimeExceptionAndReturnGaaSApiErrorResponse() throws Exception {
                ...
                assertEquals(500, result.getResponse().getStatus());
                assertEquals("{\"title\":\"NullPointerException\",\"detail\":\"Something was null\"}",
                                result.getResponse().getContentAsString());
        }
        ...
        void createFedGraph_shouldReturnBadRequest_whenServiceThrows404GaasException() throws Exception {
                doThrow(new GaaSRestApiException("Not Found", "Config not found", 404))
                                .when(createFederatedStoreGraphService)
                ...
                assertEquals(404, result.getResponse().getStatus());
                assertEquals("{\"title\":\"Not Found\",\"detail\":\"Config not found\"}",
                                result.getResponse().getContentAsString());
        }
        ...
        void createFedGraph_shouldCallCreateFedStoreGraphService_whenRequestIsFedStore() throws Exception {
                ...
                assertEquals(201, result.getResponse().getStatus());
                verify(createFederatedStoreGraphService, times(1))
                                .createFederatedStore(any(GaaSCreateRequestBody.class));
        }
